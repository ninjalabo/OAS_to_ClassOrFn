...
async def trafficMessageSimple(
...
async def trafficMessageSimpleBySituationId(
    situationId: str,
    includeAreaGeometry: Optional[bool] = None,
...
async def trafficMessageDatex2BySituationId(
...
async def trafficMessageDatex2(
    situationType: List[SituationTypeV1],
    inactiveHours: Optional[int] = None,
    api_config_override: Optional[APIConfig] = None,
) -> None:
...
async def locationById(id: int, version: Optional[str] = None, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def locationVersions(api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def areaLocationRegions_1(
    locationCode: int,
    lastUpdated: Optional[bool] = None,
    includeGeometry: Optional[bool] = None,
    effectiveDate: Optional[str] = None,
