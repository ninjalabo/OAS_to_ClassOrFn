...
async def getMaintenanceTrackingTasks(api_config_override: Optional[APIConfig] = None) -> None:
...
async def findMaintenanceTrackings(
...
async def getMaintenanceTracking(id: int, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def findLatestMaintenanceTrackings(
    endFrom: Optional[str] = None,
    xMin: Optional[float] = None,
    yMin: Optional[float] = None,
    xMax: Optional[float] = None,
...
async def getMaintenanceTrackingDomains(api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
