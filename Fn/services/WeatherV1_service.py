...
def weatherStationByRoadStationId(id: int, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def weatherDataById(id: int, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def weatherData(lastUpdated: Optional[bool] = None, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def weatherSensors(lastUpdated: Optional[bool] = None, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def forecastSectionForecastsById(id: str, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def forecastSectionSimpleById(id: str, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def forecastSectionSimpleForecastsById(id: str, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def forecastSectionsSimpleForecasts(
    lastUpdated: Optional[bool] = None,
    roadNumber: Optional[int] = None,
    xMin: Optional[float] = None,
    yMin: Optional[float] = None,
