...
class FeatureV1(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Feature name, e.g.black ice on road, or speed limit")
    quantity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Feature quantity, e.g. 30 in {speed limit, 30, km/h}")
    unit: Optional[StrictStr] = Field(default=None, description="Unit of the feature quantity, e.g. km/h in {speed limit, 30, km/h}")
    description: Optional[StrictStr] = Field(default=None, description="Further details of the feature, e.g. description of a detour")
    time_and_duration: Optional[TimeAndDurationV1] = Field(default=None, alias="timeAndDuration")
    __properties: ClassVar[List[str]] = ["name", "quantity", "unit", "description", "timeAndDuration"]
