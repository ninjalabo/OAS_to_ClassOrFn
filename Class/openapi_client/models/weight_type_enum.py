...
class WeightTypeEnum(BaseModel):
    """
    WeightTypeEnum
    """ # noqa: E501
    ...
    def value_validate_enum(cls, value):
        ...
        if value not in set(['ACTUAL', 'MAXIMUM_PERMITTED', '__EXTENDED']):
            raise ValueError("must be one of enum values ('ACTUAL', 'MAXIMUM_PERMITTED', '__EXTENDED')")
        return value
