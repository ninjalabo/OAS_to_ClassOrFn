...
class CounterFeatureModel(BaseModel):
    ...
    type: StrictStr = Field(description="Feature")
    properties: CounterModel
    __properties: ClassVar[List[str]] = ["geometry", "type", "properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "properties": CounterModel.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
