...
class SiteMeasurementsIndexPhysicalQuantity(BaseModel):
    """
    SiteMeasurementsIndexPhysicalQuantity
    """ # noqa: E501
    physical_quantity: PhysicalQuantity = Field(alias="physicalQuantity")
    index: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["physicalQuantity", "index"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of physical_quantity
        if self.physical_quantity:
            _dict['physicalQuantity'] = self.physical_quantity.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "physicalQuantity": PhysicalQuantity.from_dict(obj["physicalQuantity"]) if obj.get("physicalQuantity") is not None else None,
            "index": obj.get("index")
        })
        return _obj
