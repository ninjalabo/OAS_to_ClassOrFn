...
class InformationStatusEnum(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        ...
        if value not in set(['REAL', 'SECURITY_EXERCISE', 'TECHNICAL_EXERCISE', 'TEST', '__EXTENDED']):
            raise ValueError("must be one of enum values ('REAL', 'SECURITY_EXERCISE', 'TECHNICAL_EXERCISE', 'TEST', '__EXTENDED')")
        return value
