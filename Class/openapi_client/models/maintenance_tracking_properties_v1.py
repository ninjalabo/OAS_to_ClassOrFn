...
class MaintenanceTrackingPropertiesV1(BaseModel):
    ...
    previous_id: Optional[StrictInt] = Field(default=None, description="Id for the previous tracking if known", alias="previousId")
    sending_time: datetime = Field(description="Time when tracking was reported", alias="sendingTime")
    ...
    start_time: datetime = Field(description="Start time of maintenance work tasks", alias="startTime")
    end_time: datetime = Field(description="End time of maintenance work tasks", alias="endTime")
    ...
    __properties: ClassVar[List[str]] = ["id", "previousId", "sendingTime", "created", "tasks", "startTime", "endTime", "direction", "domain", "source"]
