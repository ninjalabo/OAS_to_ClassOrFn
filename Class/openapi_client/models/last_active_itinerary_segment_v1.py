...
class LastActiveItinerarySegmentV1(BaseModel):
    ...
    """ # noqa: E501
    start_time: datetime = Field(description="The time when the transport may start this segment.", alias="startTime")
    end_time: datetime = Field(description="Time by which the transport has finished this segment.", alias="endTime")
    legs: List[ItineraryLegV1] = Field(description="Route legs.")
    __properties: ClassVar[List[str]] = ["startTime", "endTime", "legs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "legs": [ItineraryLegV1.from_dict(_item) for _item in obj["legs"]] if obj.get("legs") is not None else None
        })
        return _obj
