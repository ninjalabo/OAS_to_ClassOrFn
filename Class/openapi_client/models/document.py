...
class Document(BaseModel):
    ...
    document_element: Optional[Element] = Field(default=None, alias="documentElement")
    input_encoding: Optional[StrictStr] = Field(default=None, alias="inputEncoding")
    xml_encoding: Optional[StrictStr] = Field(default=None, alias="xmlEncoding")
    xml_standalone: Optional[StrictBool] = Field(default=None, alias="xmlStandalone")
    xml_version: Optional[StrictStr] = Field(default=None, alias="xmlVersion")
    strict_error_checking: Optional[StrictBool] = Field(default=None, alias="strictErrorChecking")
    document_uri: Optional[StrictStr] = Field(default=None, alias="documentURI")
    dom_config: Optional[DOMConfiguration] = Field(default=None, alias="domConfig")
    ...
    __properties: ClassVar[List[str]] = ["doctype", "documentElement", "inputEncoding", "xmlEncoding", "xmlStandalone", "xmlVersion", "strictErrorChecking", "documentURI", "domConfig", "implementation", "attributes", "localName", "nodeName", "nodeValue", "parentNode", "childNodes", "firstChild", "lastChild", "previousSibling", "nextSibling", "ownerDocument", "namespaceURI", "baseURI", "textContent", "prefix", "nodeType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of doctype
        if self.doctype:
            _dict['doctype'] = self.doctype.to_dict()
        # override the default output from pydantic by calling `to_dict()` of document_element
        if self.document_element:
            _dict['documentElement'] = self.document_element.to_dict()
        # override the default output from pydantic by calling `to_dict()` of dom_config
        if self.dom_config:
            _dict['domConfig'] = self.dom_config.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "doctype": DocumentType.from_dict(obj["doctype"]) if obj.get("doctype") is not None else None,
            "documentElement": Element.from_dict(obj["documentElement"]) if obj.get("documentElement") is not None else None,
            "inputEncoding": obj.get("inputEncoding"),
            "xmlEncoding": obj.get("xmlEncoding"),
            "xmlStandalone": obj.get("xmlStandalone"),
            "xmlVersion": obj.get("xmlVersion"),
            "strictErrorChecking": obj.get("strictErrorChecking"),
            "documentURI": obj.get("documentURI"),
            "domConfig": DOMConfiguration.from_dict(obj["domConfig"]) if obj.get("domConfig") is not None else None,
