...
class AddressLineTypeEnum(BaseModel):
    """
    AddressLineTypeEnum
    """ # noqa: E501
    ...
    def value_validate_enum(cls, value):
        ...
        if value not in set(['APARTMENT', 'BUILDING', 'PO_BOX', 'UNIT', 'REGION', 'TOWN', 'DISTRICT_TERRITORY', 'FLOOR', 'STREET', 'HOUSE_NUMBER', 'GENERAL_TEXT_LINE', '__EXTENDED']):
            raise ValueError("must be one of enum values ('APARTMENT', 'BUILDING', 'PO_BOX', 'UNIT', 'REGION', 'TOWN', 'DISTRICT_TERRITORY', 'FLOOR', 'STREET', 'HOUSE_NUMBER', 'GENERAL_TEXT_LINE', '__EXTENDED')")
        return value
