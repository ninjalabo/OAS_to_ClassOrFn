...
class MaintenanceTrackingTaskDtoV1(BaseModel):
    ...
    name_fi: Optional[StrictStr] = Field(default=None, alias="nameFi")
    name_en: Optional[StrictStr] = Field(default=None, alias="nameEn")
    name_sv: Optional[StrictStr] = Field(default=None, alias="nameSv")
    data_updated_time: datetime = Field(description="Data last updated time", alias="dataUpdatedTime")
    __properties: ClassVar[List[str]] = ["id", "nameFi", "nameEn", "nameSv", "dataUpdatedTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "nameFi": obj.get("nameFi"),
            "nameEn": obj.get("nameEn"),
            "nameSv": obj.get("nameSv"),
