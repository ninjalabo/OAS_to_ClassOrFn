...
class InformationDeliveryServicesEnum(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        ...
        if value not in set(['ANY_GENERAL_DELIVERY_SERVICE', 'SAFETY_SERVICES', 'VMS', '__EXTENDED']):
            raise ValueError("must be one of enum values ('ANY_GENERAL_DELIVERY_SERVICE', 'SAFETY_SERVICES', 'VMS', '__EXTENDED')")
        return value
