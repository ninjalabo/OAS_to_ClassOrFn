...
class PhysicalQuantityFaultEnum(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        ...
        if value not in set(['INTERMITTENT_DATA_VALUES', 'NO_DATA_VALUES_AVAILABLE', 'SPURIOUS_UNRELIABLE_DATA_VALUES', 'UNSPECIFIED_OR_UNKNOWN_FAULT', 'OTHER', '__EXTENDED']):
            raise ValueError("must be one of enum values ('INTERMITTENT_DATA_VALUES', 'NO_DATA_VALUES_AVAILABLE', 'SPURIOUS_UNRELIABLE_DATA_VALUES', 'UNSPECIFIED_OR_UNKNOWN_FAULT', 'OTHER', '__EXTENDED')")
        return value
