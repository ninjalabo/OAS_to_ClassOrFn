...
class MonthOfYearEnum(BaseModel):
    """
    MonthOfYearEnum
    """ # noqa: E501
    ...
    def value_validate_enum(cls, value):
        ...
        if value not in set(['JANUARY', 'FEBRUARY', 'MARCH', 'APRIL', 'MAY', 'JUNE', 'JULY', 'AUGUST', 'SEPTEMBER', 'OCTOBER', 'NOVEMBER', 'DECEMBER', '__EXTENDED']):
            raise ValueError("must be one of enum values ('JANUARY', 'FEBRUARY', 'MARCH', 'APRIL', 'MAY', 'JUNE', 'JULY', 'AUGUST', 'SEPTEMBER', 'OCTOBER', 'NOVEMBER', 'DECEMBER', '__EXTENDED')")
        return value
