...
class WeathercamStationsPresetsPublicityHistoryV1(BaseModel):
    ...
    """ # noqa: E501
    data_updated_time: Optional[datetime] = Field(default=None, description="Latest history change time. Use this value as parameter for next query in api.", alias="dataUpdatedTime")
    stations: Optional[List[WeathercamStationPresetsPublicityHistoryV1]] = Field(default=None, description="Stations data")
    __properties: ClassVar[List[str]] = ["dataUpdatedTime", "stations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stations": [WeathercamStationPresetsPublicityHistoryV1.from_dict(_item) for _item in obj["stations"]] if obj.get("stations") is not None else None
        })
        return _obj
