...
class WeathercamStationPresetsPublicityHistoryV1(BaseModel):
    ...
    presets: List[WeathercamPresetPublicityHistoryV1] = Field(description="Id of the weathercam station")
    __properties: ClassVar[List[str]] = ["id", "dataUpdatedTime", "presets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "presets": [WeathercamPresetPublicityHistoryV1.from_dict(_item) for _item in obj["presets"]] if obj.get("presets") is not None else None
        })
        return _obj
