...
class LocationFeatureV1(BaseModel):
    ...
    id: StrictInt = Field(description="Unique locationCode for this location")
    geometry: Point
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": LocationPropertiesV1.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
