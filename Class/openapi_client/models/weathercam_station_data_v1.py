...
class WeathercamStationDataV1(BaseModel):
    ...
    presets: List[WeathercamPresetDataV1] = Field(description="Weathercam presets data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "presets": [WeathercamPresetDataV1.from_dict(_item) for _item in obj["presets"]] if obj.get("presets") is not None else None
        })
        return _obj
