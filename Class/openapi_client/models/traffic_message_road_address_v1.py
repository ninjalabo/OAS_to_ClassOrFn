...
class TrafficMessageRoadAddressV1(BaseModel):
    ...
    """ # noqa: E501
    road: StrictInt = Field(description="Number of the road")
    road_section: StrictInt = Field(description="Number of the road section", alias="roadSection")
    distance: StrictInt = Field(description="Distance from the beginning of the road section.")
    __properties: ClassVar[List[str]] = ["road", "roadSection", "distance"]
