...
class TypeInfo(BaseModel):
    ...
    type_namespace: Optional[StrictStr] = Field(default=None, alias="typeNamespace")
    __properties: ClassVar[List[str]] = ["typeName", "typeNamespace"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "typeNamespace": obj.get("typeNamespace")
        })
        return _obj
