...
class CodeDescription(BaseModel):
    ...
    Description of code
    """ # noqa: E501
    description: StrictStr = Field(description="Description of the code (Finnish)")
    description_en: StrictStr = Field(description="Description of the code(English", alias="descriptionEn")
    code: StrictStr = Field(description="Code")
    __properties: ClassVar[List[str]] = ["description", "descriptionEn", "code"]
