...
class CameraHistory(BaseModel):
    ...
    stations: Optional[List[PresetHistory]] = Field(default=None, description="Stations data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stations": [PresetHistory.from_dict(_item) for _item in obj["stations"]] if obj.get("stations") is not None else None
        })
        return _obj
