...
class ForecastSectionFeatureSimpleV1(BaseModel):
    ...
    id: StrictStr = Field(description="Forecast section identifier 15 characters ie. 00004_112_000_0, see properties id description.")
    geometry: LineString
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "geometry": LineString.from_dict(obj["geometry"]) if obj.get("geometry") is not None else None,
            "properties": ForecastSectionPropertiesSimpleV1.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
