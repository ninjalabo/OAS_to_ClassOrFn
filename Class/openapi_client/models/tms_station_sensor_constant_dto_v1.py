...
class TmsStationSensorConstantDtoV1(BaseModel):
    ...
    sensor_constant_values: List[TmsSensorConstantValueDtoV1] = Field(description="TMS Stations sensor constant values", alias="sensorConstantValues")
    __properties: ClassVar[List[str]] = ["id", "dataUpdatedTime", "sensorConstantValues"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in sensor_constant_values (list)
        _items = []
        if self.sensor_constant_values:
            for _item in self.sensor_constant_values:
                if _item:
                    _items.append(_item.to_dict())
            _dict['sensorConstantValues'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sensorConstantValues": [TmsSensorConstantValueDtoV1.from_dict(_item) for _item in obj["sensorConstantValues"]] if obj.get("sensorConstantValues") is not None else None
        })
        return _obj
