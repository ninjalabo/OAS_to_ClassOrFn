...
class WeathercamPresetHistoryDtoV1(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Weathercam preset's id")
    data_updated_time: Optional[datetime] = Field(default=None, description="Time when data was last updated", alias="dataUpdatedTime")
    history: List[WeathercamPresetHistoryItemDtoV1] = Field(description="Weathercam preset's history")
    __properties: ClassVar[List[str]] = ["id", "dataUpdatedTime", "history"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "history": [WeathercamPresetHistoryItemDtoV1.from_dict(_item) for _item in obj["history"]] if obj.get("history") is not None else None
        })
        return _obj
