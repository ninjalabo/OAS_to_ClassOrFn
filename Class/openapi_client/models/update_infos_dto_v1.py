...
class UpdateInfosDtoV1(BaseModel):
    ...
    update_times: Optional[List[UpdateInfoDtoV1]] = Field(default=None, description="Update times for APIs", alias="updateTimes")
    __properties: ClassVar[List[str]] = ["dataUpdatedTime", "updateTimes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in update_times (list)
        _items = []
        if self.update_times:
            for _item in self.update_times:
                if _item:
                    _items.append(_item.to_dict())
            _dict['updateTimes'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "updateTimes": [UpdateInfoDtoV1.from_dict(_item) for _item in obj["updateTimes"]] if obj.get("updateTimes") is not None else None
        })
        return _obj
