...
class ForecastSectionFeatureV1(BaseModel):
    ...
    geometry: ForecastSectionFeatureV1Geometry
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "geometry": ForecastSectionFeatureV1Geometry.from_dict(obj["geometry"]) if obj.get("geometry") is not None else None,
            "properties": ForecastSectionPropertiesV1.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
