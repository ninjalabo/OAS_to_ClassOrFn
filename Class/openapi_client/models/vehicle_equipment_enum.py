...
class VehicleEquipmentEnum(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        ...
        if value not in set(['NOT_USING_SNOW_CHAINS', 'NOT_USING_SNOW_CHAINS_OR_TYRES', 'SNOW_CHAINS_IN_USE', 'SNOW_TYRES_IN_USE', 'SNOW_CHAINS_OR_TYRES_IN_USE', 'WITHOUT_SNOW_TYRES_OR_CHAINS_ON_BOARD', '__EXTENDED']):
            raise ValueError("must be one of enum values ('NOT_USING_SNOW_CHAINS', 'NOT_USING_SNOW_CHAINS_OR_TYRES', 'SNOW_CHAINS_IN_USE', 'SNOW_TYRES_IN_USE', 'SNOW_CHAINS_OR_TYRES_IN_USE', 'WITHOUT_SNOW_TYRES_OR_CHAINS_ON_BOARD', '__EXTENDED')")
        return value
