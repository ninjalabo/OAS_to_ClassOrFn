...
class TimeMeaningEnum(BaseModel):
    """
    TimeMeaningEnum
    """ # noqa: E501
    ...
    def value_validate_enum(cls, value):
        ...
        if value not in set(['BEGIN_TIME', 'END_TIME', 'MIDDLE_TIME', '__EXTENDED']):
            raise ValueError("must be one of enum values ('BEGIN_TIME', 'END_TIME', 'MIDDLE_TIME', '__EXTENDED')")
        return value
