...
class ConfidentialityValueEnum(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        ...
        if value not in set(['INTERNAL_USE', 'NO_RESTRICTION', 'RESTRICTED_TO_AUTHORITIES', 'RESTRICTED_TO_AUTHORITIES_AND_TRAFFIC_OPERATORS', '__EXTENDED']):
            raise ValueError("must be one of enum values ('INTERNAL_USE', 'NO_RESTRICTION', 'RESTRICTED_TO_AUTHORITIES', 'RESTRICTED_TO_AUTHORITIES_AND_TRAFFIC_OPERATORS', '__EXTENDED')")
        return value
