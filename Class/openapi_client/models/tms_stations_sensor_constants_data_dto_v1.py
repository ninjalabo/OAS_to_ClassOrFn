...
class TmsStationsSensorConstantsDataDtoV1(BaseModel):
    ...
    """ # noqa: E501
    data_updated_time: datetime = Field(description="Time when data was last updated", alias="dataUpdatedTime")
    stations: Optional[List[TmsStationSensorConstantDtoV1]] = Field(default=None, description="Stations data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stations": [TmsStationSensorConstantDtoV1.from_dict(_item) for _item in obj["stations"]] if obj.get("stations") is not None else None
        })
        return _obj
