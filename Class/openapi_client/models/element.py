...
class Element(BaseModel):
    ...
    attribute_node_ns: Optional[Attr] = Field(default=None, alias="attributeNodeNS")
    attribute_node: Optional[Attr] = Field(default=None, alias="attributeNode")
    ...
    __properties: ClassVar[List[str]] = ["schemaTypeInfo", "attributeNodeNS", "attributeNode", "tagName", "attributes", "localName", "nodeName", "nodeValue", "parentNode", "childNodes", "firstChild", "lastChild", "previousSibling", "nextSibling", "ownerDocument", "namespaceURI", "baseURI", "textContent", "prefix", "nodeType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of attribute_node_ns
        if self.attribute_node_ns:
            _dict['attributeNodeNS'] = self.attribute_node_ns.to_dict()
        # override the default output from pydantic by calling `to_dict()` of attribute_node
        if self.attribute_node:
            _dict['attributeNode'] = self.attribute_node.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attributeNodeNS": Attr.from_dict(obj["attributeNodeNS"]) if obj.get("attributeNodeNS") is not None else None,
            "attributeNode": Attr.from_dict(obj["attributeNode"]) if obj.get("attributeNode") is not None else None,
...
Element.model_rebuild(raise_errors=False)
