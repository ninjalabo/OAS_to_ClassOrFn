...
class RegionGeometryFeatureCollectionV1(BaseModel):
    ...
    features: List[RegionGeometryFeatureV1] = Field(description="GeoJSON Feature Objects")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "features": [RegionGeometryFeatureV1.from_dict(_item) for _item in obj["features"]] if obj.get("features") is not None else None
        })
        return _obj
