...
class TmsStationSensorsDtoV1(BaseModel):
    ...
    sensors: List[TmsStationSensorDtoV1] = Field(description="Available sensors of road stations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sensors": [TmsStationSensorDtoV1.from_dict(_item) for _item in obj["sensors"]] if obj.get("sensors") is not None else None
        })
        return _obj
