...
class DayEnum(BaseModel):
    ...
    def value_validate_enum(cls, value):
        ...
        if value not in set(['MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FRIDAY', 'SATURDAY', 'SUNDAY', '__EXTENDED']):
            raise ValueError("must be one of enum values ('MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FRIDAY', 'SATURDAY', 'SUNDAY', '__EXTENDED')")
        return value
