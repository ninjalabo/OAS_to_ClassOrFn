...
class LowEmissionLevelEnum(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        ...
        if value not in set(['LOW_LEVEL_EMISSION', 'FREE_OF_EMISSION', '__EXTENDED']):
            raise ValueError("must be one of enum values ('LOW_LEVEL_EMISSION', 'FREE_OF_EMISSION', '__EXTENDED')")
        return value
