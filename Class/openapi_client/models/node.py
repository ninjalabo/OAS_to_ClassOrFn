...
class Node(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["attributes", "localName", "nodeName", "nodeValue", "parentNode", "childNodes", "firstChild", "lastChild", "previousSibling", "nextSibling", "ownerDocument", "namespaceURI", "baseURI", "textContent", "prefix", "nodeType"]
