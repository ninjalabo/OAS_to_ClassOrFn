...
class MaintenanceTrackingDomainDtoV1(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the maintenance tracking domain")
    source: StrictStr = Field(description="Source and owner of the data")
    data_updated_time: datetime = Field(description="Data last updated time", alias="dataUpdatedTime")
    __properties: ClassVar[List[str]] = ["name", "source", "dataUpdatedTime"]
