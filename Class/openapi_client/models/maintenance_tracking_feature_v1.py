...
class MaintenanceTrackingFeatureV1(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="GeoJSON Feature Object")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "properties": MaintenanceTrackingPropertiesV1.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
