...
class LocationFeatureCollectionV1(BaseModel):
    ...
    locations_version: StrictStr = Field(description="Locations version", alias="locationsVersion")
    data_updated_time: datetime = Field(description="Data last updated date time", alias="dataUpdatedTime")
    features: List[LocationFeatureV1] = Field(description="GeoJSON Feature Objects")
    __properties: ClassVar[List[str]] = ["type", "locationsVersion", "dataUpdatedTime", "features"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "locationsVersion": obj.get("locationsVersion"),
            "dataUpdatedTime": obj.get("dataUpdatedTime"),
            "features": [LocationFeatureV1.from_dict(_item) for _item in obj["features"]] if obj.get("features") is not None else None
        })
        return _obj
