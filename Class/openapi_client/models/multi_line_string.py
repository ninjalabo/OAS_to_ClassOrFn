...
class MultiLineString(GeometryObject):
    ...
    """ # noqa: E501
    type: StrictStr
    coordinates: List[List[List[Union[StrictFloat, StrictInt]]]] = Field(description="An array of LineString coordinates. Coordinates are in WGS84 format in decimal degrees: [LONGITUDE, LATITUDE, {ALTITUDE}]. Altitude is optional and measured in meters.")
