...
class TmsStationPropertiesSimpleV1(BaseModel):
    ...
    tms_number: StrictInt = Field(description="TMS station number (naturalId) for legacy support", alias="tmsNumber")
    ...
    __properties: ClassVar[List[str]] = ["id", "tmsNumber", "name", "collectionStatus", "state", "dataUpdatedTime"]
