...
class WeatherStationSensorsDtoV1(BaseModel):
    ...
    data_last_checked_time: datetime = Field(description="Data last checked date time", alias="dataLastCheckedTime")
    sensors: List[WeatherStationSensorDtoV1] = Field(description="Available sensors of road stations")
    __properties: ClassVar[List[str]] = ["dataUpdatedTime", "dataLastCheckedTime", "sensors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dataLastCheckedTime": obj.get("dataLastCheckedTime"),
            "sensors": [WeatherStationSensorDtoV1.from_dict(_item) for _item in obj["sensors"]] if obj.get("sensors") is not None else None
        })
        return _obj
