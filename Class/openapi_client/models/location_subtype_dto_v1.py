...
class LocationSubtypeDtoV1(BaseModel):
    ...
    description_fi: StrictStr = Field(description="Description of subtype in finnish", alias="descriptionFi")
    description_en: StrictStr = Field(description="Description of subtype in english", alias="descriptionEn")
    __properties: ClassVar[List[str]] = ["subtypeCode", "descriptionFi", "descriptionEn"]
