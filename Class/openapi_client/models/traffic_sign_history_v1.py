...
class TrafficSignHistoryV1(BaseModel):
    ...
    effect_date: Optional[datetime] = Field(default=None, alias="effectDate")
    __properties: ClassVar[List[str]] = ["cause", "rows", "displayValue", "additionalInformation", "effectDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cause": obj.get("cause"),
            "rows": [HistoryTextRowV1.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None,
