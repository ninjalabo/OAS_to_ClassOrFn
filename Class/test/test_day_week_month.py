...
class TestDayWeekMonth(unittest.TestCase):
    """DayWeekMonth unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DayWeekMonth:
        """Test DayWeekMonth
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DayWeekMonth`
        """
        model = DayWeekMonth()
        if include_optional:
            return DayWeekMonth(
