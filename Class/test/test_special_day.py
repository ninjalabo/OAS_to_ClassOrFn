...
class TestSpecialDay(unittest.TestCase):
    """SpecialDay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpecialDay:
        """Test SpecialDay
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpecialDay`
        """
        model = SpecialDay()
        if include_optional:
            return SpecialDay(
