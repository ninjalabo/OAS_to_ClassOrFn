...
class TestFacilityLocation(unittest.TestCase):
    """FacilityLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FacilityLocation:
        """Test FacilityLocation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FacilityLocation`
        """
