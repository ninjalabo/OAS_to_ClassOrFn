...
class TestHeaderInformation(unittest.TestCase):
    """HeaderInformation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HeaderInformation:
        """Test HeaderInformation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HeaderInformation`
        """
        model = HeaderInformation()
        if include_optional:
