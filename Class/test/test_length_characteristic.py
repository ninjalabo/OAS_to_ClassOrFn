...
class TestLengthCharacteristic(unittest.TestCase):
    """LengthCharacteristic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LengthCharacteristic:
        """Test LengthCharacteristic
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LengthCharacteristic`
        """
        model = LengthCharacteristic()
        if include_optional:
    ...
    def testLengthCharacteristic(self):
        """Test LengthCharacteristic"""
