...
class TestHeaviestAxleWeightCharacteristic(unittest.TestCase):
    """HeaviestAxleWeightCharacteristic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HeaviestAxleWeightCharacteristic:
        """Test HeaviestAxleWeightCharacteristic
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HeaviestAxleWeightCharacteristic`
        """
        model = HeaviestAxleWeightCharacteristic()
        if include_optional:
    ...
    def testHeaviestAxleWeightCharacteristic(self):
        """Test HeaviestAxleWeightCharacteristic"""
