...
class TestLocationV1(unittest.TestCase):
    """LocationV1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocationV1:
        """Test LocationV1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocationV1`
        """
        model = LocationV1()
        if include_optional:
            return LocationV1(
