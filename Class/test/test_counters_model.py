...
class TestCountersModel(unittest.TestCase):
    """CountersModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountersModel:
        """Test CountersModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountersModel`
        """
        model = CountersModel()
        if include_optional:
            return CountersModel(
                features = [
                    openapi_client.models.counter_feature_model.CounterFeatureModel(
