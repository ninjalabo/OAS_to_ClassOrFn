...
class TestRoadPointV1(unittest.TestCase):
    """RoadPointV1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoadPointV1:
        """Test RoadPointV1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoadPointV1`
        """
        model = RoadPointV1()
        if include_optional:
            return RoadPointV1(
