...
class TestDOMConfiguration(unittest.TestCase):
    """DOMConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DOMConfiguration:
        """Test DOMConfiguration
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DOMConfiguration`
        """
        model = DOMConfiguration()
        if include_optional:
