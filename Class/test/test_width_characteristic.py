...
class TestWidthCharacteristic(unittest.TestCase):
    """WidthCharacteristic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WidthCharacteristic:
        """Test WidthCharacteristic
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WidthCharacteristic`
        """
        model = WidthCharacteristic()
        if include_optional:
    ...
    def testWidthCharacteristic(self):
        """Test WidthCharacteristic"""
