...
class TestHeightCharacteristic(unittest.TestCase):
    """HeightCharacteristic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HeightCharacteristic:
        """Test HeightCharacteristic
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HeightCharacteristic`
        """
        model = HeightCharacteristic()
        if include_optional:
    ...
    def testHeightCharacteristic(self):
        """Test HeightCharacteristic"""
