...
class TestFeatureV1(unittest.TestCase):
    """FeatureV1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeatureV1:
        """Test FeatureV1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeatureV1`
        """
        model = FeatureV1()
        if include_optional:
            return FeatureV1(
