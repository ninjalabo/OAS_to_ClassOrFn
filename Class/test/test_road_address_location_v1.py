...
class TestRoadAddressLocationV1(unittest.TestCase):
    """RoadAddressLocationV1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoadAddressLocationV1:
        """Test RoadAddressLocationV1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoadAddressLocationV1`
        """
        model = RoadAddressLocationV1()
        if include_optional:
            return RoadAddressLocationV1(
    ...
    def testRoadAddressLocationV1(self):
        """Test RoadAddressLocationV1"""
