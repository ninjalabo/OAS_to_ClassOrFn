...
class TestGrossWeightCharacteristic(unittest.TestCase):
    """GrossWeightCharacteristic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GrossWeightCharacteristic:
        """Test GrossWeightCharacteristic
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrossWeightCharacteristic`
        """
        model = GrossWeightCharacteristic()
        if include_optional:
    ...
    def testGrossWeightCharacteristic(self):
        """Test GrossWeightCharacteristic"""
