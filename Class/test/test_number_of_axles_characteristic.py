...
class TestNumberOfAxlesCharacteristic(unittest.TestCase):
    """NumberOfAxlesCharacteristic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NumberOfAxlesCharacteristic:
        """Test NumberOfAxlesCharacteristic
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NumberOfAxlesCharacteristic`
        """
        model = NumberOfAxlesCharacteristic()
        if include_optional:
    ...
    def testNumberOfAxlesCharacteristic(self):
        """Test NumberOfAxlesCharacteristic"""
