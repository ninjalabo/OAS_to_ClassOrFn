...
class TestRestrictionV1(unittest.TestCase):
    """RestrictionV1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestrictionV1:
        """Test RestrictionV1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestrictionV1`
        """
        model = RestrictionV1()
        if include_optional:
            return RestrictionV1(
                type = 'SPEED_LIMIT',
