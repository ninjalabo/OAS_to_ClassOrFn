...
class TestTimePeriodOfDay(unittest.TestCase):
    """TimePeriodOfDay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimePeriodOfDay:
        """Test TimePeriodOfDay
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimePeriodOfDay`
        """
        model = TimePeriodOfDay()
        if include_optional:
