...
class TestCounterModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CounterModel:
        """Test CounterModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CounterModel`
        """
        model = CounterModel()
        if include_optional:
            return CounterModel(
