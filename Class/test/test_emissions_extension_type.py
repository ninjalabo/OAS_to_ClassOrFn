...
class TestEmissionsExtensionType(unittest.TestCase):
    """EmissionsExtensionType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmissionsExtensionType:
        """Test EmissionsExtensionType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmissionsExtensionType`
        """
        model = EmissionsExtensionType()
        if include_optional:
            return EmissionsExtensionType(
    ...
    def testEmissionsExtensionType(self):
        """Test EmissionsExtensionType"""
