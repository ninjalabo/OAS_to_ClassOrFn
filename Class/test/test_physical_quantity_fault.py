...
class TestPhysicalQuantityFault(unittest.TestCase):
    """PhysicalQuantityFault unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhysicalQuantityFault:
        """Test PhysicalQuantityFault
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PhysicalQuantityFault`
        """
        model = PhysicalQuantityFault()
        if include_optional:
            return PhysicalQuantityFault(
    ...
    def testPhysicalQuantityFault(self):
        """Test PhysicalQuantityFault"""
