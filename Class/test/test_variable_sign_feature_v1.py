...
class TestVariableSignFeatureV1(unittest.TestCase):
    """VariableSignFeatureV1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VariableSignFeatureV1:
        """Test VariableSignFeatureV1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VariableSignFeatureV1`
        """
        model = VariableSignFeatureV1()
        if include_optional:
            return VariableSignFeatureV1(
                type = '',
    ...
    def testVariableSignFeatureV1(self):
        """Test VariableSignFeatureV1"""
