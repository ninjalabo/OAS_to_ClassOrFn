...
class TestAxleCharacteristics(unittest.TestCase):
    """AxleCharacteristics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AxleCharacteristics:
        """Test AxleCharacteristics
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AxleCharacteristics`
        """
        model = AxleCharacteristics()
        if include_optional:
    ...
    def testAxleCharacteristics(self):
        """Test AxleCharacteristics"""
