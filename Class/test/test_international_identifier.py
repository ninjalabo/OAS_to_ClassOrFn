...
class TestInternationalIdentifier(unittest.TestCase):
    """InternationalIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InternationalIdentifier:
        """Test InternationalIdentifier
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InternationalIdentifier`
        """
        model = InternationalIdentifier()
        if include_optional:
    ...
    def testInternationalIdentifier(self):
        """Test InternationalIdentifier"""
