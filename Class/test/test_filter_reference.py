...
class TestFilterReference(unittest.TestCase):
    """FilterReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilterReference:
        """Test FilterReference
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilterReference`
        """
